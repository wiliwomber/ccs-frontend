...
var CardMedia = function (_PureComponent) {
  ...
  CardMedia.prototype.render = function render() {
    ...
    return React.createElement(
      Media,
      _extends({ className: cn('md-card-media', className) }, props),
      children,
      overlay
    );
  };
...
CardMedia.propTypes = {
  ...
  deprecated: componentDeprecated('There were no unique styles for media in cards so it is simpler to just use the ' + '`Media` component.')
};
